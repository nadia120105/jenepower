...
# begitu kamu sudah hitung mean/max/min per musim dari data ERA5.
STATS_DUMMY = {
    "wind": {
        "DJF":  {"Mean": "5.69 m/s", "Max": "15.21 m/s", "Min": "0.01 m/s"},
        "JJA":  {"Mean": "3.95 m/s", "Max": "11.94 m/s", "Min": "0.01 m/s"},
        "MAM":  {"Mean": "4.68 m/s", "Max": "13.18 m/s", "Min": "0.01 m/s"},
        "SON":  {"Mean": "4.95 m/s", "Max": "13.45 m/s", "Min": "0.01 m/s"},
        "MEAN": {"Mean": "4.82 m/s", "Max": "13.87 m/s", "Min": "0.01 m/s"},
    },
    "swh": {
        "DJF":  {"Mean": "1.42 m", "Max": "3.88 m", "Min": "0.12 m"},
        "JJA":  {"Mean": "0.91 m", "Max": "2.45 m", "Min": "0.08 m"},
        "MAM":  {"Mean": "1.10 m", "Max": "2.90 m", "Min": "0.09 m"},
        "SON":  {"Mean": "1.18 m", "Max": "3.05 m", "Min": "0.10 m"},
        "MEAN": {"Mean": "1.15 m", "Max": "3.88 m", "Min": "0.08 m"},
    },
    "precip": {
        "DJF":  {"Mean": "210 mm", "Max": "480 mm", "Min": "20 mm"},
        "JJA":  {"Mean": "40 mm",  "Max": "150 mm", "Min": "0 mm"},
        "MAM":  {"Mean": "120 mm", "Max": "310 mm", "Min": "10 mm"},
        "SON":  {"Mean": "150 mm", "Max": "350 mm", "Min": "15 mm"},
        "MEAN": {"Mean": "130 mm", "Max": "480 mm", "Min": "0 mm"},
    },
    "temp2m": {
        "DJF":  {"Mean": "27.8 °C", "Max": "30.1 °C", "Min": "25.6 °C"},
        "JJA":  {"Mean": "26.4 °C", "Max": "28.9 °C", "Min": "24.2 °C"},
        "MAM":  {"Mean": "27.2 °C", "Max": "29.5 °C", "Min": "25.0 °C"},
        "SON":  {"Mean": "27.6 °C", "Max": "29.8 °C", "Min": "25.3 °C"},
        "MEAN": {"Mean": "27.3 °C", "Max": "30.1 °C", "Min": "24.2 °C"},
    },
}
...
def stat_box(var_key: str, musim: str):
    stats = STATS_DUMMY.get(var_key, {}).get(musim, {})
    rows = "".join(
...
if selected == "Home":
    ...
    kpis = [
        ...
        ("27.3 °C", "Rerata Temp 2m"),
        ("1.15 m", "Rerata Wave Height"),
    ...
    st.markdown("<div class='section-title'>Batimetri 3D</div>", unsafe_allow_html=True)
    st.markdown("<div class='plot-card'>", unsafe_allow_html=True)
    load_html_file(HTML_DIR / BATHY_FILE, height=600)
    st.markdown("</div>", unsafe_allow_html=True)
