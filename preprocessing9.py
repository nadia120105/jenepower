...
# CSS dasar (berisi nilai default = Dark mode, lihat style.css)
...
.stat-box, .about-card, .ph-card {
    box-shadow: 0 4px 16px rgba(20,25,58,0.06);
}
</style>
"""
...
# ════════════════════════════════════════════════════════════════
    ...
    bcol_l, bcol_mid, bcol_r = st.columns([1, 6, 1])
    with bcol_mid:
        st.markdown("""
        <p class='about-txt' style='text-align:center;margin:0 0 18px;'>
        ...
        <div class='stat-box' style='margin-top:18px;'>
            ...
            <p><span class='stat-label'>Titik Terdalam (Min)</span><span class='stat-val'>-4036.00 m</span></p>
            <p><span class='stat-label'>Titik Terdangkal (Max)</span><span class='stat-val'>-1.00 m</span></p>
            <p><span class='stat-label'>Rata-rata (Mean)</span><span class='stat-val'>-781.94 m</span></p>
